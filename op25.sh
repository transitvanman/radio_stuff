...
./rx.py --args 'soapy' --antenna 'A' --gains "IFGR range:45,RFGR range:4" -S 2048000 -f 420.0125 -o 50000 -d 600 -l http:0.0.0.0:8888 -T trunk.tsv -v 5 -V -2 -w -M my_meta.json 2> stderr.2
